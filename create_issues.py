...
issues = [
    {
        "title": "Bug: cargo budget-report ignores --network during simulation",
        "labels": ["bug"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Bug: Budget macros break tests that return Result or use early returns",
        "labels": ["bug"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Bug: Malformed budget.toml is silently ignored",
...
"""
    ...
    {
        "title": "Bug: Invalid value in env = \"VAR\" limit silently disables the assertion",
        "labels": ["bug", "good first issue"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: Assertion mode for cargo budget-report",
        "labels": ["enhancement"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: Baseline/snapshot mode with % tolerance",
        "labels": ["enhancement"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: Combined #[budget_lt(cpu = N, mem = M)] macro + configurable env ident",
        "labels": ["enhancement"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: Replace curl subprocess with a native Rust HTTP client",
        "labels": ["enhancement"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: --package/--function filters and contract-id reuse",
        "labels": ["enhancement"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: Markdown output + GitHub Actions job summary integration",
        "labels": ["enhancement"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Bug: cargo-budget-report exits with 0 even if function simulations fail",
        "labels": ["bug"],
        "body": """**Description:**
...
"""
    ...
    {
        "title": "Feature: Configurable cargo build profile override",
...
for i, issue in enumerate(issues, 1):
    filename = f"issue_{i}.md"
    with open(filename, "w") as f:
        f.write(issue["body"])
    
    cmd = f'gh issue create --title "{issue["title"]}" --body-file {filename} '
